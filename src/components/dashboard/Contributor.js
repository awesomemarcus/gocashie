...
export default () => {
  return (
    <div id="contributor" className="flex flex-col">
      ...
      <div className="dashboard-box mb-3 bg-white rounded shadow-md overflow-hidden">
        <div className="head bg-gray-100 py-2 px-3 border-b">
           <h1 className="font-bold text-sm">Next Payment Day</h1> 
        </div>
        <div className="body p-3">
          <p className="text-2xl tracking-wider">December 21, 2019</p>
        </div>
      </div>
      ...
      <div className="dashboard-box mb-3 bg-white rounded shadow-md overflow-hidden">
        ...
        <div className="body p-3">
          <p className="text-2xl tracking-wider">$1, 000, 000.00</p>
        </div>
      </div>
    </div>
  );
