...
export default () => {
	const {
		loans: { list, outstanding_balance, total },
	} = useAppActions();
	...
	return (
		<div id="contributor" className="flex flex-col">
			...
			<div className="dashboard-box mb-3 bg-white rounded shadow-md overflow-hidden">
				<div className="head bg-gray-100 py-2 px-3 border-b">
					<h1 className="font-bold text-sm">Current Loan Amount</h1>
				</div>
				<div className="body p-3">
					<p className="text-2xl tracking-wider">
			...
			<div className="dashboard-box mb-3 bg-white rounded shadow-md overflow-hidden">
				<div className="head bg-gray-100 py-2 px-3 border-b">
					<h1 className="font-bold text-sm">Total Loan Interest</h1>
				</div>
				<div className="body p-3">
					<p className="text-2xl tracking-wider">
			...
			<div className="dashboard-box mb-3 bg-white rounded shadow-md overflow-hidden">
				...
				<div className="body p-3">
					<p className="text-2xl tracking-wider">
						{list.length > 0
							? moment(list[0].next_payment_date).format('MMMM DD YYYY')
							: ''}
					</p>
				</div>
			</div>
